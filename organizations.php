            ...
            <div class="main_menu">
                <div class="container">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        ...
                        <a class="Looper" href="index.html">Organizations Information</a>
...
$sql=" select h.bloodorganization_id, 
h.bloodorganization_Name, CONCAT(l.street_address, ', ', l.city_name) AS Address,
 l.postal_code,l.country_name, h.bloodorganization_ContactNo
from bloodorganization h, location l
...
if($result ->num_rows>0){
  ...
  while( $row= $result -> fetch_assoc()){
    echo "<tr><td>". $row['bloodorganization_id'] ."</td><td>" . $row['bloodorganization_Name'] . "</td><td>". $row['Address'] ."</td><td>" . $row['postal_code'] .  "</td><td>" . 
	 $row['bloodorganization_ContactNo'] . "</td><td>" . $row['country_name'] ."</td></tr>";
  }
  echo "</table>";
}
else {

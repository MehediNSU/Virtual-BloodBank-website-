            ...
            <div class="main_menu">
                <div class="container">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        ...
                        <a class="Looper" href="#">Hospitals Information</a>
...
$sql=" select h.hospitals_id, h.Hospitals_Name, CONCAT(l.street_address, ' ,', l.city_name) AS Address, l.postal_code,l.country_name, h.Hospitals_ContactNo
from hospitals h, location l
...
if($result ->num_rows>0){
  ...
  while( $row= $result -> fetch_assoc()){
    echo "<tr><td>". $row['hospitals_id'] ."</td><td>" . $row['Hospitals_Name'] . "</td><td>". $row['Address'] ."</td><td>" . $row['postal_code'] .  "</td><td>" . 
	 $row['Hospitals_ContactNo'] . "</td><td>" . $row['country_name'] ."</td></tr>";
  }
  echo "</table>";
}
else {
echo "No Hospial Found";
}
